...
namespace SAPFunction.Services
{
    public partial class InvenMessageService
    {
        ...
        /// <returns></returns>
        internal List<string> GetSaveUnitTransactionSql(MessageHeader mh, List<InvenMessage> dataList)
        {
            ...
            foreach (InvenMessage unit in dataList)
            {
        ...
        /// <param name="err"></param>
        /// <returns></returns>
        internal bool saveUnitTransaction(MessageHeader mh, List<InvenMessage> dataList, out string err)
        {
            List<string> sqlList = new List<string>();
            if (mh.MESSAGE_HEADER_ID != null && mh.MESSAGE_HEADER_ID.Length > 0) //edit
            {
