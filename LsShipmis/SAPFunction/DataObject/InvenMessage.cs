 ...
 * 文 件 名：InvenMessage.cs
 * 创 建 人：王鹏程
 * 创建时间：2011/7/6
 * 标    题：实体类
 * 功能描述：T_INVEN_MESSAGE数据实体类
 * 修 改 人：
 * 修改时间：
 * 修改内容：
 ****************************************************************************************************/
...
namespace SAPFunction.DataObject
{
    ...
    /// </summary>
    ///[Serializable]
    public partial class InvenMessage : CommonClass
    {
        #region 构造函数
        ///<summary> 
        ///
        ...
        {
            this.INVEN_MESSAGE_ID = iNVEN_MESSAGE_ID;
        ...
        ///
        ///</summary>
        public string INVEN_MESSAGE_ID { get; set; }
        ...
        public override CommonClass Clone()
        {
            ...
            Unit.INVEN_MESSAGE_ID = this.INVEN_MESSAGE_ID;
        ...
        {
            return InvenMessageService.Instance.saveUnit(this, out err);
        }

        public override bool Delete(out string err)
        {
            return InvenMessageService.Instance.deleteUnit(this, out err);
        }
