...
namespace Repair.Services
{
    ...
    /// 报警业务类.
    /// </summary>
    public class RepairApplyAlertOnce : CommonOperation.Interfaces.IRemind
    {
        ...
        {
            RemindService.Instance.DeleteByType(1);
        ...
        public static IRemind GetAlarmObject()
        {
            ...
            RemindService.Instance.GetInfoByCondition(1, out dtb, out err);
            if (dtb != null && dtb.Rows.Count > 0)
            {
                message = dtb.Rows.Count + "条新修理申请审核完成";
                return (IRemind)new RepairApplyAlertOnce();
            }
