 ...
 * 文 件 名：CostDisorder.cs
 * 创 建 人：夏喜龙
 * 创建时间：2011-8-24
 * 标    题：实体类
 * 功能描述：T_COST_DISORDER数据实体类
 * 修 改 人：
 * 修改时间：
 * 修改内容：
 ****************************************************************************************************/
...
namespace Cost.DataObject
{
	...
	/// </summary>
	///[Serializable]
	public partial class CostDisorder : CommonClass
	{		
		#region 构造函数
		///<summary> 
		///船舶杂费管理.
        ...
        {
            return CostDisorderService.Instance.saveUnit(this, out err);
        }

        public override bool Delete(out string err)
        {
            return CostDisorderService.Instance.deleteUnit(this, out err);
        }
