...
namespace Cost.Alert
{
    ...
    /// 凭证报警
    /// </summary>
    public class VoucherAlertOnce : CommonOperation.Interfaces.IRemind
    {
        ...
        {
            RemindService.Instance.DeleteByType(7);
        ...
        public static IRemind GetAlarmObject()
        {
            ...
            sb.AppendLine(" and r.REMIND_TYPE=7");
            ...
            {
                message = dtb.Rows.Count + "条新凭证申请审核完成";

                return (IRemind)new VoucherAlertOnce();
            }
            return null;
        }
    }
