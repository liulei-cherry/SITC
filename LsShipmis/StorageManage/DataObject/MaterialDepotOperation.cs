 ...
 * 文 件 名：MaterialDepotOperation.cs
 * 创 建 人：徐正本
 * 创建时间：2011/8/16
 * 标    题：实体类
 * 功能描述：T_MATERIAL_DEPOT_OPERATION数据实体类
 * 修 改 人：
 * 修改时间：
 * 修改内容：
 ****************************************************************************************************/
...
{
    /// <summary>
    ///T_MATERIAL_DEPOT_OPERATION数据实体.
    /// </summary>
    ///[Serializable]
    public partial class MaterialDepotOperation : CommonClass
    {
        #region 构造函数
        ...
        {
            return "MaterialDepotOperation";
        }

        public override bool Update(out string err)
        {
            return MaterialDepotOperationService.Instance.saveUnit(this, out err);
        }

        public override bool Delete(out string err)
        {
            return MaterialDepotOperationService.Instance.deleteUnit(this, out err);
        }
