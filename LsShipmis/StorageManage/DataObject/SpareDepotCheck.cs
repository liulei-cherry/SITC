 ...
 * 文 件 名：SpareDepotCheck.cs
 * 创 建 人：徐正本
 * 创建时间：2011/8/11
 * 标    题：实体类
 * 功能描述：T_SPARE_DEPOT_CHECK数据实体类
 * 修 改 人：
 * 修改时间：
 * 修改内容：
 ****************************************************************************************************/
...
{
    /// <summary>
    ///T_SPARE_DEPOT_CHECK数据实体.
    /// </summary>
    ///[Serializable]
    public partial class SpareDepotCheck : CommonClass
    {
        #region 构造函数
        ///<summary> 
        ///盘点,对于某个库的物资进行盘点.
        ///</summary>
        public SpareDepotCheck()
        {
        }
        ///<summary>
        ///盘点,对于某个库的物资进行盘点.
        ...
        {
            return "SpareDepotCheck";
        }

        public override bool Update(out string err)
        {
            return SpareDepotCheckService.Instance.saveUnit(this, out err);
        }

        public override bool Delete(out string err)
        {
            return SpareDepotCheckService.Instance.deleteUnit(this, out err);
        }
