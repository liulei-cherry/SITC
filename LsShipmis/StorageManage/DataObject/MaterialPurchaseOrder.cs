 ...
 * 文 件 名：MaterialPurchaseOrder.cs
 * 创 建 人：王鹏程
 * 创建时间：2011/9/18
 * 标    题：实体类
 * 功能描述：T_MATERIAL_PURCHASE_ORDER数据实体类
 * 修 改 人：
 * 修改时间：
 * 修改内容：
 ****************************************************************************************************/
...
{
	/// <summary>
	///T_MATERIAL_PURCHASE_ORDER数据实体.
	/// </summary>
	///[Serializable]
	public partial class MaterialPurchaseOrder : CommonClass
	{		
		#region 构造函数
		///<summary> 
		///
		///</summary>
		public MaterialPurchaseOrder()
		{
		}
		///<summary>
		///
        ...
        {
            return MaterialPurchaseOrderService.Instance.saveUnit(this, out err);
        }

        public override bool Delete(out string err)
        {
            return MaterialPurchaseOrderService.Instance.deleteUnit(this, out err);
        }
