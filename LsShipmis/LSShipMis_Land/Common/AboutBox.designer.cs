namespace LSShipMis_Land.Common
{
    partial class AboutBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "产品名称 : 船舶管理系统(C#版)";
            ...
            this.labelVersion.Text = "     版本: 公司端 2.0";
            ...
            this.labelCompanyName.Text = "公司名称 : 大连陆海科技股份有限公司";
            ...
            this.textBox1.Text = "\r\n本计算机程序受版权法和国家条约保护。如未经授权而擅自复制或传播本程序（或其中任何部分），将受到严厉的民事和刑事制裁，并将在法律许可的最大限度内受到起诉。";
            // 
            // AboutBox
            // 
