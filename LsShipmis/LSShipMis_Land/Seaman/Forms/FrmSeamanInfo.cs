...
using LSShipMis_Land.Seaman.Services;
...
namespace LSShipMis_Land.Seaman.Forms
{
    ...
    public partial class FrmSeamanInfo : CommonViewer.BaseForm.FormBase
    {
        ...
        private void checkRight()
        {
            ...
            toolStripButton2.Visible = CommonOperation.ConstParameter.SupperUser;
        }
        ...
        private void setDataGridView()
        {
            ...
            dgvSeaman.Columns["username"].HeaderText = "中文名";
        ...
        private void bdNgSaveItem_Click(object sender, EventArgs e)
        {
            ...
            if (dgvSeaman.Rows.Count > 0)
            {
                ...
                {
                    MessageBoxEx.Show("船员中文名是必填内容！", "警告", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    txtChName.Focus();
                    return;
                }
            ...
            if (err.Equals(""))
            {
                ...
                ////调用用户注册窗口.
                //SysLs.Forms.FrmSysUser frm = new SysLs.Forms.FrmSysUser(1);
                //frm.ShowDialog();
                ////调用用户角色权限窗口.
                //SysLs.Forms.FrmShipUserHead frmRight = new SysLs.Forms.FrmShipUserHead(1);
                //frmRight.ShowDialog();
