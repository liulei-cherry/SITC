...
namespace CommonOperation
{
    ...
    public class Smtp
    {
        ...
        public void SendMail(string from, List<String> to, string subject, string body, Boolean isHtmlBody)
        {
        ...
        public void SendMail(string from, List<String> to, string subject, string body, List<String> attList, Boolean isHtmlBody)
        {
            MailMsg msg = new MailMsg();
            msg.Subject = subject;
            msg.Body = body;
            msg.From = from;
            msg.To = to;
            msg.AttachmentList = attList; msg.IsHtmlBody = isHtmlBody;
            SendMail(msg);
        }
        /// <summary>
        /// 发送邮件
        ...
        public void SendMail(string from, List<String> to, string subject, string body,
            List<String> attList, string host, int port, string username, string password, Boolean isHtmlBody)
        {
            MailMsg msg = new MailMsg();
            msg.Subject = subject;
            msg.Body = body;
        ...
        public void SendMail(MailMsg msg)
        {
            ...
            message.IsBodyHtml = msg.IsHtmlBody;
            foreach (String toAddress in msg.To)
            {
                message.To.Add(toAddress);//邮件配送地址
            }
    ...
    public class MailMsg
    {
        ...
        /// <summary>
        /// 附件列表(附件的全路径和名称Example:D:\trans\send\SS9990010001e.MIS)
        /// </summary>
        public List<String> AttachmentList { get; set; }
        /// <summary>
        /// 邮件正文是否使用HTML标记
        /// </summary>
        public Boolean IsHtmlBody { get { return isHtmlBody; } set { isHtmlBody = value; } }
    }
